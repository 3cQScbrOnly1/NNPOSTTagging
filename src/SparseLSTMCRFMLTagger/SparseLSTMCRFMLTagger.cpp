...
#include "SparseLSTMCRFMLTagger.h"
...
void Tagger::train(const string& trainFile, const string& devFile, const string& testFile, const string& modelFile, const string& optionFile) {
	...
	if (m_options.charFile != "")
		m_driver._model_params.chars.initial(&m_driver._model_params._char_alpha, m_options.charFile, m_options.charEmbFineTune);
	else
		m_driver._model_params.chars.initial(&m_driver._model_params._char_alpha, m_options.charEmbSize, m_options.charEmbFineTune);
